...
void _seasonMetadataEntityAttach(
  ...
  object.id = id;
  object.tvShow.attach(
    col,
    col.isar.collection<TVShowMetadataEntity>(),
    r'tvShow',
    id,
  );
  object.episodes.attach(
    col,
    col.isar.collection<EpisodeMetadataEntity>(),
    r'episodes',
    id,
  );
}
...
extension SeasonMetadataEntityByIndex on IsarCollection<SeasonMetadataEntity> {
  ...
  List<Id> putAllBySeasonKeySync(
    List<SeasonMetadataEntity> objects, {
    bool saveLinks = true,
  }) {
...
extension SeasonMetadataEntityQueryWhere
  ...
  seasonKeyEqualTo(String seasonKey) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.equalTo(indexName: r'seasonKey', value: [seasonKey]),
      );
    });
  }
...
extension SeasonMetadataEntityQueryFilter
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  seasonKeyEqualTo(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  seasonKeyStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.startsWith(
          property: r'seasonKey',
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  seasonKeyEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.endsWith(
          property: r'seasonKey',
  ...
  seasonKeyIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'seasonKey', value: ''),
      );
    });
  }
  ...
  seasonKeyIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'seasonKey', value: ''),
      );
    });
  }
...
extension SeasonMetadataEntityQueryLinks
    on
        QueryBuilder<
          SeasonMetadataEntity,
          SeasonMetadataEntity,
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  tvShow(FilterQuery<TVShowMetadataEntity> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  episodes(FilterQuery<EpisodeMetadataEntity> q) {
    return QueryBuilder.apply(this, (query) {
